...
# instantiating cars
name = "Peraid"
# peraido = Car(name="Peraido 161", tyre=Tyre("Alborz"), gear=automated_gear7, tormoz=tormoz_abs)
peraido = Car(name=name, tyre=Tyre("Alborz"), gear=automated_gear7, tormoz=tormoz_abs)
